				...
				<main class="site-main" id="main">
					...
					<section class="error-404 not-found">
						...
						<header class="page-header">
							...
							<h1 class="page-title"><?php esc_html_e('WhooooOops! That page can&rsquo;t be found.', 'understrap'); ?></h1>

							<div class="text-center">
								<img src="<?= get_template_directory_uri() . '-child/img/gnome-face-logo-navy.svg' ?>" alt="" class="mb-2" style="max-width: 100%; height: 30vh;">
							</div>
